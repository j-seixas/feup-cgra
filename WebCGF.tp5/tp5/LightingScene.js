...
LightingScene.prototype.init = function(application) {
    ...
    this.materialSecondsPtr = new CGFappearance(this);
    this.materialSecondsPtr.setAmbient(0.05, 0.05, 0.05, 1);
    this.materialSecondsPtr.setDiffuse(0.8, 0.1, 0.1, 1);
    this.materialSecondsPtr.setSpecular(0.5, 0.5, 0.5, 1);
    this.materialSecondsPtr.setShininess(100);
